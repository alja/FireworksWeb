#ifndef FireworksWeb_Core_FWConfiguration_h
#define FireworksWeb_Core_FWConfiguration_h
// -*- C++ -*-
//
// Package:     Core
// Class  :     FWConfiguration
//
/**\class FWConfiguration FWConfiguration.h FireworksWeb/Core/interface/FWConfiguration.h
