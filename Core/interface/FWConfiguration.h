#ifndef Fireworks2_Core_FWConfiguration_h
#define Fireworks2_Core_FWConfiguration_h
// -*- C++ -*-
//
// Package:     Core
// Class  :     FWConfiguration
//
/**\class FWConfiguration FWConfiguration.h Fireworks2/Core/interface/FWConfiguration.h
