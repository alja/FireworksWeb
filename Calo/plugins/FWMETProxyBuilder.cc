...
public:
   ...
   using REveDataSimpleProxyBuilderTemplate<reco::MET>::BuildItemViewType;
   virtual void BuildItemViewType(const reco::MET& met, int /*idx*/, ROOT::Experimental::REveElement* iItemHolder, const std::string& viewType, const REveViewContext*) override
   {
